"""
Django settings for optimess project.
...
MIDDLEWARE = [
    ...
    'optimess.middleware.NoCacheMiddleware',   # prevent back-button to login (must be after AuthenticationMiddleware)
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'optimess.urls'
...
WSGI_APPLICATION = 'optimess.wsgi.application'
