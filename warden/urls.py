...
urlpatterns = [
    ...
    path('broadcast/history/', views.warden_broadcast_history, name='warden_broadcast_history'),
    path('broadcast/delete/<int:broadcast_id>/', views.delete_broadcast, name='delete_broadcast'),
